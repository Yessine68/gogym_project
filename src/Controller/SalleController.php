...
class SalleController extends AbstractController
{
    ...
    public function showSalle(Salle $salle,SalleRepository $repo): Response
    ...
    {   $notifications = $this->getDoctrine()->getRepository(Notification::class)->findAll();
        ...
        return $this->renderForm('Salle/CreateSalle.html.twig',['form'=>$form, 'notifications' => $notifications]);
    ...
    {   $notifications = $this->getDoctrine()->getRepository(Notification::class)->findAll();
        ...
        return $this->render('Salle/search.html.twig', ["Salles"=>$Salles, "query"=>$query, 'notifications' => $notifications]);
    }
    ...
    {   $notifications = $this->getDoctrine()->getRepository(Notification::class)->findAll();
        ...
        return $this->render('Salle/ReadSalleBack.html.twig', [
            'Salles' => $sortByAscPerimetreSalle,
            "query"=>$query,
            'notifications' => $notifications,
        ]);
    }
