...
class ProduitMobileController extends AbstractController
{
    ...
    public function add(Request $request, CategorieRepository $categorieRepository): JsonResponse
    {
        ...
        return $this->manage($produit, $categorieRepository,  $request, false);
    }
    ...
    public function edit(Request $request, ProduitRepository $produitRepository, CategorieRepository $categorieRepository): Response
    {
        ...
        return $this->manage($produit, $categorieRepository, $request, true);
    }

    public function manage($produit, $categorieRepository, $request, $isEdit): JsonResponse
    {   
